...
router.post(`/addAddress`, authMiddleware, async (req, res) => {
    const {FlatNumber, Floor, Locality, landmark, Name, Contact_Number, AddressAs } = req.body;
    ...
    userExist.Address = await userExist.Address.concat({FlatNumber, Floor, Locality, landmark, Name, Contact_Number, AddressAs})
    userExist.save();
