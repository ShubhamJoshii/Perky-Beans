...
const AddNewAddress = ({setShowBag}) => {
  ...
  const submitForm = async(e) => {
    e.preventDefault();
    const arr = [AddressData.Floor, AddressData.FlatNumber, AddressData.Locality, AddressData.landmark];
  ...
  return (
    <div id='Add-New-Address'>
        ...
        <div id="SaveAddressAs">
          <button className='save-Address-As' id={AddressData.AddressAs === "Home" ? "active" : ""} onClick={()=>handleSaveAddressAs("Home")}><img src={Home} alt='HomeLogo' /><span>Home</span></button>
          <button className='save-Address-As' id={AddressData.AddressAs === "Work" ? "active" : ""} onClick={()=>handleSaveAddressAs("Work")}><img src={Building} alt='HomeLogo' /><span>Work</span></button>
          <button className='save-Address-As' id={AddressData.AddressAs === "Hotel" ? "active" : ""} onClick={()=>handleSaveAddressAs("Hotel")}><img src={Hotel} alt='HomeLogo' /><span>Hotel</span></button>
          <button className='save-Address-As' id={AddressData.AddressAs === "Other" ? "active" : ""} onClick={()=>handleSaveAddressAs("Other")}><img src={Other} alt='HomeLogo' /><span>Other</span></button>
        </div>
